...
public class Bootstrapper extends BaseCommandLine {
    ...
    public void execute() throws Exception {
        System.out.println("*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*");
        System.out.println("*           Metadata Model Service Bootstrapper             *");
        System.out.println("*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*");
        System.out.println("");
        mmsEtcDir = new File(getServiceMixEtc().getAbsolutePath() + File.separator + MMS_SERVICE_DIR);
        mmsEtcDir.mkdirs();
    ...
    private void configureMetadataModelService() throws Exception {
        ...
        props.store(new FileOutputStream(config), "Metadata Model Service Configuration saved by bootstrapper on "
                + new Date());
    }
    ...
    private void configureWSRFService() throws Exception {
        ...
        props.store(new FileOutputStream(wsrfConfig),
                "Metadata Model WSRF Service Configuration saved by bootstrapper on " + new Date());
    }
