...
public class TestSerializationDeserialization extends TestCase {
    ...
    public void testAuthenticateUserResponse() {
        try {
            ...
            gov.nih.nci.cagrid.opensaml.SAMLAssertion saml = null;
            ...
            saml = new gov.nih.nci.cagrid.opensaml.SAMLAssertion(issuer, start, end, null, null, l);
            ...
            gov.nih.nci.cagrid.opensaml.SAMLAssertion saml2 = res2.getAssertion();
            saml2.verify(cert);
            try {
